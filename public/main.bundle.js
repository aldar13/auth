    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [{
                    ...
                    useClass: __WEBPACK_IMPORTED_MODULE_17__services_auth_interceptor__["a" /* AuthInterceptor */],
                    multi: true,
                }, __WEBPACK_IMPORTED_MODULE_13__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]],
...
var AuthService = (function () {
    ...
    AuthService.prototype.getProfile = function () {
        this.loadToken();
        var header = { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]().set('Authorization', "Bearer" + this.authToken) };
        return this.http.get('users/profile', header);
    };
